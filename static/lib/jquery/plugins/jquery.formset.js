...
//                    replacement = prefix + '-' + ndx + '-';
        ...
        if ($$.length) {
            ...
            if ($$.attr('tagName') == 'TR') {
                ...
                $$.parent().append('<tr><td colspan="' + 3 + '" class="left_side">  <a class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a></tr>');
                addButton = $$.parent().find('tr:last a');
                addButton.parents('tr').addClass(options.formCssClass + '-add');
            } else {
                // Otherwise, insert it immediately after the last form:
                $$.filter(':last').after('<tr><td colspan="' + 3 + '" class="left_side"><a class="' + options.addCssClass + '" href="javascript:void(0)">' + options.addText + '</a></tr>');
    ...
    $.fn.formset.defaults = {
        ...
        addText: 'اضافه کردن فایل',          // Text for the add link
